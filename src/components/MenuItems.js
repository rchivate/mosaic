let MenuItems = [
    {
        ...
        appetizers: [
            {
                name: "tzatziki",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/tzatziki.png",
                description: "A creamy yogurt dip with dill and cucumber served with pita chips.",
                price: "$5.00"
            },
            {
                name: "Choriatiki",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/choriatiki.png",
        ...
        mainCourse: [
            {
                name: "Spanakopita",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/spanakopita.png",
                description: "Leafy spinach and tangy feta cheese wrapped in between layers of baked phyllo dough.",
                price: "$12.50"
            },
            {
                name: "Vegetarian Moussaka",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/mousakka.png",
        ...
        dessert: [
            {
                name: "Galaktoboureko",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/galaktoboureko.png",
                description: "Layers of custard baked in phyllo dough soaked with a sweet syrup.",
                price: "$7.50"
            },
            {
                name: "Kourabiedes",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/kourabiedes.png",
        ...
        drinks: [
            {
                name: "Soumada",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/soumada.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/zucchinigratin.png",
                description: "Sautéed zucchini strips with a bell pepper, tomato, and parmesan filling.",
                price: "$6.50"
            },
            {
                name: "Fromage Fort",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/fromagefort.png",
        ...
        mainCourse: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/belugalentils.png",
                description: "Lentils braised in a tomato-based broth with fresh kale and rosemary.",
                price: "$15.00"
            },
            {
                name: "Onion Soup",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/onionsoup.png",
        ...
        dessert: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/macaron.png",
                description: "Two crisp meringue cookies made of almond flour, egg whites, and sugar sandwiched with buttercream.",
                price: "$8.00"
            },
            {
                name: "Chocolate Soufflé",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chocolate.png",
        ...
        drinks: [
            {
                name: "Chocolat Chaud",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chocolatchaud.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                name: "Oil Muchim",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/oilmuchim.png",
                description: "Cucumbers marinated in soy sauce, rice vinegar, and red chili sauce, topped with sesame seeds.",
                price: "$5.00"
            },
            {
                name: "Gamjajeon",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/gamjajeon.png",
        ...
        mainCourse: [
            {
                name: "Bibimbap",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/bibimbap.png",
                description: "A Korean rice bowl mixed with veggies, gochujang sauce, topped with a runny egg.",
                price: "$15.00"
            },
            {
                name: "Gochujang Noodles",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/gochujangnoodles.png",
        ...
        dessert: [
            {
                name: "Songpyeon",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/songpyeon.png",
                description: "A rice cake made with rice powder, matcha tea powder, dried mung beans, and sesame seeds.",
                price: "$7.50"
            },
            {
                name: "Dasik",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/dasik.png",
        ...
        drinks: [
            {
                name: "Saenggang Cha",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/saenggangcha.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                name: "Shiro Wat",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/shirowat.png",
            ...
            },
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/eggplantsalad.png",
        ...
        mainCourse: [
            {
                name: "Injera",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/injera.png",
                description: "A fermented flatbread served with an assortment of cooked vegetables and stews.",
                price: "$17.50"
            },
            {
                name: "Gomen Wat",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/gomenwat.png",
        ...
        dessert: [
            {
                name: "Dabo Kolo",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/dabokolo.png",
                description: "Fried wheat dough mixed with sugar, salt, and butter.",
                price: "$5.00"
            },
            {
                name: "Tibinga",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/tibinga.png",
        ...
        drinks: [
            {
                name: "Bunna",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/bunna.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/salademechouia.png",
                description: "A salad made with roasted peppers, tomatoes, onions, and garlic topped with a lemon and olive oil dressing.",
                price: "$8.00"
            },
            {
                name: "Lablabi",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/lablabi.png",
        ...
        mainCourse: [
            {
                name: "Couscous",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/couscous.png",
                description: "Lentils and vegetables cooked with spices and olive oil.",
                price: "$11.00"
            },
            {
                name: "Vegetarian Tagine",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/vegetariantangine.png",
        ...
        dessert: [
            {
                name: "Baklava",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/baklava.png",
                description: "Layers of baked phyllo dough filled with nuts and soaked in a sweet syrup.",
                price: "$6.00"
            },
            {
                name: "Kalb El Louz",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/kalbellouz.png",
        ...
        drinks: [
            {
                name: "Mint Tea",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/minttea.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                name: "Causa Limena",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/causalimena.png",
            ...
            },
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chocloconqueso.png",
        ...
        mainCourse: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/arrozconvegetales.png",
                description: "A rice dish made with rice, vegetables, and seasoned with spices and aji amarillo sauce.",
                price: "$15.00"
            },
            {
                name: "Tacu Tacu",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/tacutacu.png",
        ...
        dessert: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/suspirodelimena.png",
            ...
            {
                name: "Picarones",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/picarones.png",
        ...
        drinks: [
            {
                name: "Chicha Morada",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chichamorada.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                name: "Guacamole",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/guacamole.png",
                description: "A dip made with avocados, tomatoes, onion, lime, and spices, served with tortilla chips.",
                price: "$5.00"
            },
            {
                name: "Chile Relleno",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chilerelleno.png",
        ...
        mainCourse: [
            {
                name: "Enchiladas",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/enchillada.png",
                description: "Baked corn tortillas filled with cheese and beans, covered with ranchero sauce.",
                price: "$15.00"
            },
            {
                name: "Quesadillas",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/quesadilla.png",
        ...
        dessert: [
            {
                name: "Churros",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/churros.png",
                description: "A fried pastry topped with cinnamon sugar.",
                price: "$5.00"
            },
            {
                name: "Tres Leches Cake",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/treslechescake.png",
        ...
        drinks: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/chocolatecalliente.png",
    ...
    },
    {
        ...
        appetizers: [
            {
                name: "Samosa",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/samosa.png",
                description: "A triangle-shaped fried pastry filled with mashed potatoes, peas, and spices, served with chutney.",
                price: "$5.00"
            },
            {
                name: "Onion Pakora",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/onionpakora.png",
        ...
        mainCourse: [
            {
                ...
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/paneerbuttermasala.png",
                description: "Cottage cheese (paneer) served in a tomato and onion-based sauce with spices, accompanied by naan.",
                price: "$15.00"
            },
            {
                name: "Biryani",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/biryani.png",
        ...
        dessert: [
            {
                name: "Gulab Jamun",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/gulabjamun.png",
                description: "Fried balls made out of milk solids soaked in sugar syrup.",
                price: "$7.50"
            },
            {
                name: "Rasmalai",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/rasmalai.png",
        ...
        drinks: [
            {
                name: "Mango Lassi",
                imageUrl: "https://rchivate.github.io/mosaic/images/menu/mangolassi.png",
