        ...
        <div className='container'>
            ...
            <div className="grid-container">
                <div className="grid-item">
                    <img src='https://rchivate.github.io/mosaic/images/chef.png' />
                    <h2>👨‍🍳Our Team👨‍🍳</h2>
                    <p>
                ...
                <div className="grid-item">
                    <img src='https://rchivate.github.io/mosaic/images/ecofriendly.jpg' />
                ...
                <div className="grid-item">
                    <img src='https://rchivate.github.io/mosaic/images/discount.jpg' />
                ...
                <div className="grid-item">
                    <img src='https://rchivate.github.io/mosaic/images/donate.jpg' />
                    <h2>💵Food Donation💵</h2>
                    <p>
