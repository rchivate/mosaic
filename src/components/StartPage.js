...
export default function StartPage() {
    return (
        <div className='container'>
            ...
            <section>
                <img className='logo' src='https://rchivate.github.io/mosaic/images/webmaster-main-logo.png' alt="LOGO" />
            </section>
            ...
            <section className='intro-flag'>
                ...
                <div className='flag-cards-grid'>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/algeria-flag.png' alt="Algeria" />
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/ethiopia-flag.png' alt="Ethiopia" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/france-flag.png' alt="France" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/greece-flag.png' alt="Greece" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/india-flag.png' alt="India" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/mexico-flag.png' alt="Mexico" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/peru-flag.png' alt="Placeholder 1" />
                    </div>
                    ...
                    <div className='flag-cards'>
                        ...
                        <img className='flag-cards-img' src='https://rchivate.github.io/mosaic/images/south-korea-flag.png' alt="Placeholder 1" />
                    </div>
                </div>
            </section>
